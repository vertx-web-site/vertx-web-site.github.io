...
export const meta = {
  ...
  authors: [{
    ...
    github_id: "ricardohmon"
  }],
  summary: "This blog entry describes an approach to adopt Continuous Delivery for Vert.x applications using Jenkins and Ansible by taking advantage of the Jenkins Job DSL and Ansible plugins."
}
...
<img src={require("../assets/blog/continuous-delivery-jenkins-ansible/ansible-jenkins-overview.svg")} alt="Overview of the continous delivery process" />
...
<Alert info title="Host processing order">
...
If our solution includes a load balancer or proxy, we could deal with them at this step as described in Ansible's [best practices](http://docs.ansible.com/ansible/playbooks_delegation.html) for rolling updates
...
<Alert info title="Tool configuration assumption">
...
<iframe src="https://www.youtube.com/embed/GQd_Rfeu6Yo" frameBorder="0" allowFullScreen></iframe>
</div>
