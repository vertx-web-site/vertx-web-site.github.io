...
summary: >-
  This blog entry describes an approach to adopt Continuous Delivery for Vert.x
  applications using Jenkins and Ansible by taking advantage of the Jenkins Job
  DSL and Ansible plugins.
---
...
![Overview of the continous delivery process](/images/blog/continuous-delivery-jenkins-ansible/ansible-jenkins-overview.svg)
...
<YouTubeEmbed id="GQd_Rfeu6Yo" title="Continuous Delivery for Vert.x with Jenkins and Ansible" />
