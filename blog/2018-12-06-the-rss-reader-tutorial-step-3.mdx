export const meta = {
  ...
  summary: "This is the third installment of our Vert.x Cassandra Client tutorial. We will implement the last RSS endpoint serving a list of articles related to a specific channel."
}
...
The RSS reader example assumes implementing three endpoints. This article is dedicated to implementing the last `GET /articles/by_rss_link?link={rss_link}` endpoint.
...
During the series, we have shown how the RSS reader app can be implemented with the [Vert.x Cassandra client](https://github.com/vert-x3/vertx-cassandra-client).

Thanks for reading this. I hope you enjoyed this series. See you soon on our [Gitter channel](https://gitter.im/eclipse-vertx/vertx-users)!
