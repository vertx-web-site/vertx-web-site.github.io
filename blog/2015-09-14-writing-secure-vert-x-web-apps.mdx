export const meta = {
  ...
  summary: "This is a starting guide for securing Vert.x web applications. Standard rules and practices apply to Vert.x apps as if they would to any other web framework."
}
...
<img src={require("../assets/blog/vertx3-secure-webapps/nocookie.png")} alt="nocookie" />
