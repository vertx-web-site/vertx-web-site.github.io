...
authors:
  - name: Paolo Patierno
    github_id: ppatierno
summary: >-
  I have to admit … before joining Red Hat I didn’t know about the Eclipse
  Vert.x project but it took me few days to fall in love with it!
---

import Alert from "@/components/Alert"

![Vert.x IoT](/images/blog/vertx-iot/vertx-iot.png)
