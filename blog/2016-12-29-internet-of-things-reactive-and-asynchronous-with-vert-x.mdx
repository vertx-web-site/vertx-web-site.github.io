...
export const meta = {
  ...
  summary: "I have to admit … before joining Red Hat I didn’t know about the Eclipse Vert.x project but it took me few days to fall in love with it!"
}

<img src={require("../assets/blog/vertx-iot/vertx-iot.png")} alt="Vert.x IoT" />

<Alert info>

This is a re-publication of the following [blog post](https://paolopatierno.wordpress.com/2016/12/27/internet-of-things-reactive-and-asynchronous-with-vert-x/).
