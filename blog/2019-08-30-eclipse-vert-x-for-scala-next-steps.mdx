export const meta = {
  ...
  summary: "This blog post gives an overview of the current plans for the vertx-lang-scala module, in particular with respect to the upcoming Vert.x 4."
}
...
It's been more than two years since the inception of `vertx-lang-scala` to the Vert.x ecosystem. And almost as long since I wrote my first [blog post](https://vertx.io/blog/scala-is-here/) about it.
