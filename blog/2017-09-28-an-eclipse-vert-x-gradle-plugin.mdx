export const meta = {
  ...
  summary: "The new Vert.x Gradle plugin offers an opinionated plugin for building Vert.x applications with Gradle."
}
...
<iframe src="https://www.youtube.com/embed/OGy-1w8Z6Dc?rel=0" frameBorder="0" allowFullScreen></iframe>
</div>
