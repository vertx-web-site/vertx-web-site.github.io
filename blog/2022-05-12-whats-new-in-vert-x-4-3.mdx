...
A Vert.x URI [template](https://vertx.io/docs/vertx-uri-template/java/) can be created

```java
UriTemplate REQUEST_URI = UriTemplate.of("/users{/user}");
```

a web client can [use](https://vertx.io/docs/vertx-web-client/java/#_uri_templates) to send a request
...
Vert.x HTTP servers can [compress](https://vertx.io/docs/vertx-core/java/#_http_compression_algorithms) to brotli and gzstandard in addition of gzip.

Vert.x HTTP client can [decompress](https://vertx.io/docs/vertx-core/java/#_handling_compressed_body) brotli in addition of gzip.
