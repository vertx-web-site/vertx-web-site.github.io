...
authors:
  - name: Julien Viet
    github_id: vietj
summary: >-
  This is the first milestone of the upcoming Vert.x 4. It extends the 3.x
  callback asynchronous model to a future/callback hybrid model and introduces a
  Tracing API.
---
...
![Screenshot](/images/blog/vertx-4-milestone1-release/vertx-4-timeline.png)
