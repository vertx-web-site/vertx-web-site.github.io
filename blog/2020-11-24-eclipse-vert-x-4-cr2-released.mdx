...
authors:
  - name: Julien Viet
    github_id: vietj
summary: >-
  The second release candidate of the upcoming Vert.x 4 has just been released. We
...
with a custom third-party repository ([TAP](https://docs.brew.sh/Taps)) and a vertx4 formula:
