...
authors:
  - name: Julien Viet
    github_id: vietj
summary: >-
  The next milestone release of Vert.x 4 aims to provide a reliable distribution
  of the current development for people who want to try it and provide feedback.
---
...
![Screenshot](/images/blog/vertx-4-milestone3-release/vertx-4-timeline.png)
