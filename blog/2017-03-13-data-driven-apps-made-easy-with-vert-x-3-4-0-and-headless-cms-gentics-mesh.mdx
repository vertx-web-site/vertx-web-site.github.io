...
authors:
  - name: Johannes Schüth
    github_id: jotschi
summary: >-
  I would like to share why Vert.x is not only a robust foundation for the
  headless Content Management System Gentics Mesh but also how it can be used to
  build a template-based web server.
---
...
![Gentics Mesh User Interface](/images/blog/vertx-mesh/mesh-ui.jpg)
...
![Mesh Schemas](/images/blog/vertx-mesh/mesh-schemas.jpg)
...
![Handlebars Template Overview](/images/blog/vertx-mesh/mesh-vertx-templates.jpg)
