...
export const meta = {
  ...
  summary: "I would like to share why Vert.x is not only a robust foundation for the headless Content Management System Gentics Mesh but also how it can be used to build a template-based web server."
}
...
<img src={require("../assets/blog/vertx-mesh/mesh-ui.jpg")} alt="Gentics Mesh User Interface" />
...
<Gist url="https://gist.github.com/Jotschi/39fc0d3fcd45122eafe68d61bea4c120" file="main.java" />
...
<Gist url="https://gist.github.com/Jotschi/39fc0d3fcd45122eafe68d61bea4c120" file="start.java" />
...
<Gist url="https://gist.github.com/Jotschi/39fc0d3fcd45122eafe68d61bea4c120" file="pathHandler.java" />
...
<Gist url="https://gist.github.com/Jotschi/39fc0d3fcd45122eafe68d61bea4c120" file="routeHandler.java" />

<img src={require("../assets/blog/vertx-mesh/mesh-schemas.jpg")} alt="Mesh Schemas" />
...
<img src={require("../assets/blog/vertx-mesh/mesh-vertx-templates.jpg")} alt="Handlebars Template Overview" />
...
<Gist url="https://gist.github.com/Jotschi/39fc0d3fcd45122eafe68d61bea4c120" file="template.example" />
