export const meta = {
  ...
  summary: "The new milestone of Vert.x 4 makes progress in futurisation and includes improvements on the mail client, general clients, and security."
}
...
Some Vert.x clients are designed to be used within the verticle that created it while some can be shared between
...
<img src={require("../assets/blog/vertx-4-milestone4-release/vertx-4-timeline.png")} alt="Screenshot" />
