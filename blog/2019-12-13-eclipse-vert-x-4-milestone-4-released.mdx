...
authors:
  - name: Julien Viet
    github_id: vietj
summary: >-
  The new milestone of Vert.x 4 makes progress in futurisation and includes
  improvements on the mail client, general clients, and security.
---
...
![Screenshot](/images/blog/vertx-4-milestone4-release/vertx-4-timeline.png)
