...
authors:
  - name: Pavel Drankov
    github_id: Sammers21
summary: >-
  In this tutorial, you will learn how to use the Eclipse Vert.x Cassandra
  client in practice. We will develop an RSS reader with three HTTP endpoints.
---
...
<img src="https://i.imgur.com/2V954zx.png" width="1012" height="661" alt="see how it looks" />
