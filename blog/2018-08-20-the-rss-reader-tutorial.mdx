export const meta = {
  ...
  summary: "In this tutorial, you will learn how to use the Eclipse Vert.x Cassandra client in practice. We will develop an RSS reader with three HTTP endpoints."
}
...
<img src="https://i.imgur.com/2V954zx.png" alt="see how it looks" className="img-fluid" />
