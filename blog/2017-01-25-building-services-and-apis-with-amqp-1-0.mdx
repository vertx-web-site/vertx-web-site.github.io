...
authors:
  - name: Jakub Scholz
    github_id: scholzj
summary: >-
  Microservices and APIs are everywhere. Everyone talks about them, presentation
  slides are full of them ... some people are actually even building them.
---
...
![](/images/blog/services-and-apis-with-amqp/HTTP-API.png)
...
![API with AMQP server](/images/blog/services-and-apis-with-amqp/AMQP-Server-API.png)
...
![AMQP API with Dispatch router](/images/blog/services-and-apis-with-amqp/AMQP-API.png)
...
![Multicasting messages](/images/blog/services-and-apis-with-amqp/AMQP-API-multicast.png)
