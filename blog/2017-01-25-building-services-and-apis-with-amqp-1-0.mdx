...
export const meta = {
  ...
  summary: "Microservices and APIs are everywhere. Everyone talks about them, presentation slides are full of them ... some people are actually even building them."
}
...
This is a re-publication of the following [blog post](http://blog.effectivemessaging.com/2017/01/building-services-and-apis-with-amqp-10.html)
...
<img src={require("../assets/blog/services-and-apis-with-amqp/HTTP-API.png")} />
...
<img src={require("../assets/blog/services-and-apis-with-amqp/AMQP-Server-API.png")} alt="API with AMQP server" />
...
<img src={require("../assets/blog/services-and-apis-with-amqp/AMQP-API.png")} alt="AMQP API with Dispatch router" />
...
<img src={require("../assets/blog/services-and-apis-with-amqp/AMQP-API-multicast.png")} alt="Multicasting messages" />
