...
summary: >-
  This blog post is part of the introduction to Vert.x series. We are now going
  to replace this JDBC client by the vertx-mongo-client, and thus connect to a
  Mongo database.
---
...
![Asynchronous data access](/images/blog/intro-series/async-data.png)
...
![The application live and running](/images/blog/intro-series/whisky-mongo.png)
