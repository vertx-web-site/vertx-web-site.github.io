...
export const meta = {
  ...
  summary: "This blog post is part of the introduction to Vert.x series. We are now going to replace this JDBC client by the vertx-mongo-client, and thus connect to a Mongo database."
}
...
1. The <Link href="/blog/[[...slug]]" as="/blog/my-first-vert-x-3-application/" passHref={true}><a>first post</a></Link> has described how to build a vert.x application with Maven and execute unit tests.
2. The <Link href="/blog/[[...slug]]" as="/blog/vert-x-application-configuration/" passHref={true}><a>second post</a></Link> has described how this application can become configurable.
3. The <Link href="/blog/[[...slug]]" as="/blog/some-rest-with-vert-x/" passHref={true}><a>third post</a></Link> has introduced [vertx-web](http://vertx.io/docs/vertx-web/java/), and a small collection management application has been developed. This application offers a REST API used by a HTML/JavaScript frontend.
4. The <Link href="/blog/[[...slug]]" as="/blog/unit-and-integration-tests/" passHref={true}><a>fourth post</a></Link> has presented how you can run integration tests to ensure the behavior of your application.
5. The <Link href="/blog/[[...slug]]" as="/blog/using-the-asynchronous-sql-client/" passHref={true}><a>last post</a></Link> has presented how you can interact with a JDBC database using the vertx-jdbc-client.
...
<img src={require("../assets/blog/intro-series/async-data.png")} alt="Asynchronous data access" />
...
<Alert info title="Some changes in the integration tests">
...
<img src={require("../assets/blog/intro-series/whisky-mongo.png")} alt="The application live and running" />
