export const meta = {
  ...
  summary: "Vert.x Web distinguishes itself from traditional application servers like JavaEE by just being a simple extension toolkit to Vert.x, which makes it quite lightweight and small but nevertheless very powerful."
}
...
<p>
<img src={require("../assets/blog/vertx3-web-easy-as-pi/rpi.png")} alt="Screenshot" />
</p>
