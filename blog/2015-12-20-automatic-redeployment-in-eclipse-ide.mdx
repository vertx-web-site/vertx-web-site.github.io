export const meta = {
  ...
  summary: "Vert.x 3.1 has (re-)introduced the redeploy feature. This blog post explains how to use this feature in the Eclipse IDE. However, you can easily adapt the content to your IDE."
}
...
<iframe src="https://www.youtube.com/embed/iyZwAzEVX-o" frameBorder="0" allowFullScreen></iframe>
</div>
