...
export const meta = {
  ...
  summary: "Let's say you have a Vert.x 3 application you want to install on a Linux server. But you want the old school way (I mean not the Docker way)."
}
...
<Gist url="https://gist.github.com/cescoffier/ccc8b391787e93f4e6e0" />
