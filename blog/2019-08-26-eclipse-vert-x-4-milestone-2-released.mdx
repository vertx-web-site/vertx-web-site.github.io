...
authors:
  - name: Julien Viet
    github_id: vietj
summary: >-
  The new milestone release of Vert.x 4 includes progress on futurisation,
  tracing, and many other improvements.
---
...
![Screenshot](/images/blog/vertx-4-milestone2-release/vertx-4-timeline.png)
