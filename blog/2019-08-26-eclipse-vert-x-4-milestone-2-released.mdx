export const meta = {
  ...
  summary: "The new milestone release of Vert.x 4 includes progress on futurisation, tracing, and many other improvements."
}
...
<img src={require("../assets/blog/vertx-4-milestone2-release/vertx-4-timeline.png")} alt="Screenshot" />
