export const meta = {
  ...
  summary: "On October 21th, 2015 we all rejoiced with the return from the past of Marty McFly with his flying car and so on, however in the Vert.x world we were quite sad about our rather old JavaScript support."
}
...
With all these nostalgic thoughts on my mind I've decided to bring us back to the future and by future I mean, let's
 start using a modern JavaScript, or more correctly, let's start using [ECMAScript 6](http://es6-features.org/).
