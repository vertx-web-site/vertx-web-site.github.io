...
If you followed the previous [series](/blog/my-first-vert-x-3-application/) on Vert.x development, you saw
...
If you do not know why there is the dependency on `vertx3-full` or why the added `scripts` property please check the [older](/blog/vert-x3-says-hello-to-npm-users/) blog post about it.
