...
export const meta = {
  ...
  summary: "One of the interesting features of Vert.x is the SockJS event bus bridge. It allows external applications to communicate with Vert.x event bus using Websockets."
}
...
<img src={require("../assets/blog/vertx3-realtime-webapps/screencast.gif")} alt="Screencast" />

## Bootstrap a project

If you followed the previous <Link href="/blog/[[...slug]]" as="/blog/my-first-vert-x-3-application/" passHref={true}><a>series</a></Link> on Vert.x development, you saw
...
If you do not know why there is the dependency on `vertx3-full` or why the added `scripts` property please check the <Link href="/blog/[[...slug]]" as="/blog/vert-x3-says-hello-to-npm-users/" passHref={true}><a>older</a></Link> blog post about it.
