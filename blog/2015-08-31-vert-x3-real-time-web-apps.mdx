...
authors:
  - name: Paulo Lopes
    github_id: pmlopes
summary: >-
  One of the interesting features of Vert.x is the SockJS event bus bridge. It
  allows external applications to communicate with Vert.x event bus using
  Websockets.
---
...
![Screencast](/images/blog/vertx3-realtime-webapps/screencast.gif)
