export const meta = {
  ...
  authors: [{
    name: "Mark Spritzler",
    github_id: "bytor99999"
  }],
  summary: "So while upgrading our application, I thought I should note down all the changes that we had to do in the process. Since Vert.x 3 is a major upgrade from the previous version, with so many changes."
}
