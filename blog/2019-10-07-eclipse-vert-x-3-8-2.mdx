export const meta = {
  ...
  summary: "This version is a bug fix release of Vert.x 3.8.3, which addresses quite a few bugs reported by the community."
}
...
Since the release of Vert.x 3.8.1, quite a few bugs have been reported. We would like to thank you all for reporting these issues.
