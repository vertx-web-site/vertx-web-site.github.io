export const meta = {
  ...
  summary: "Vert.x Unit is a very elegant library to test asynchronous applications developed with vert.x. However because of this asynchronous aspect, reporting test failures is not natural for JUnit users."
}
...
Notice that vertx-unit does not need JUnit, and can be used without it. Check the Vert.x Unit [documentation](https://vertx.io/docs/vertx-unit/java/) for more details.
