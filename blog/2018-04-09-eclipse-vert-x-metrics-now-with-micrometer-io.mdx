...
authors:
  - name: Joel Takvorian
    github_id: jotak
summary: >-
  The new vertx-micrometer-metrics module provides support for collecting
  metrics with Micrometer.io and storing them in backends such as Graphite or
  InfluxDB.
---
...
<img src="https://raw.githubusercontent.com/jotak/vertx-examples/micrometer-example/micrometer-metrics-examples/grafana/http-server-metrics.png" width="1657" height="806" alt="HTTP server metrics" />

##### Event bus metrics

<img src="https://raw.githubusercontent.com/jotak/vertx-examples/micrometer-example/micrometer-metrics-examples/grafana/eventbus-metrics.png" width="1654" height="523" alt="Event bus metrics" />
