...
export const meta = {
  ...
  summary: "The new vertx-micrometer-metrics module provides support for collecting metrics with Micrometer.io and storing them in backends such as Graphite or InfluxDB."
}
...
Prometheus is used in the following examples, but equivalent queries can be performed with _InfluxDB_.
...
At the moment, it is not possible to report metrics to several backends at the same time. [It might be soon implemented](https://github.com/vert-x3/vertx-micrometer-metrics/issues/16).
...
<img alt="HTTP server metrics" className="img-fluid" src="https://raw.githubusercontent.com/jotak/vertx-examples/micrometer-example/micrometer-metrics-examples/grafana/http-server-metrics.png" />

##### Event bus metrics

<img alt="Event bus metrics" className="img-fluid" src="https://raw.githubusercontent.com/jotak/vertx-examples/micrometer-example/micrometer-metrics-examples/grafana/eventbus-metrics.png" />
