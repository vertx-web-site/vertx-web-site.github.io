export const meta = {
  ...
  summary: "This new version is a bug fix release that addresses issues reported in Eclipse Vert.x 3.8.1. We also updated Netty to version 4.1.39.Final to fix some CVEs."
}

We have just released Vert.x 3.8.1, a bug fix release of Vert.x 3.8.x.

This version updates to Netty 4.1.39.Final fixing the following HTTP/2 related CVEs:
