...
During the development of Vert.x 5, many features have been made available and back-ported to Vert.x 4 such as
virtual thread support, dynamic SQL pool, on the fly SSL update, WebSocket client, various builders and much more.
