...
export const meta = {
  ...
  authors: [{
    name: "Usman Saleem",
    github_id: "usmansaleem"
  }],
  summary: "In this blog post, I demonstrate how to write a very simple TCP client that keeps a connection open to a custom-written server in cloud."
}
...
<Gist url="https://gist.github.com/usmansaleem/b5838484a20cb8b08f236f2265ad7a8e" />
...
<Gist url="https://gist.github.com/usmansaleem/750c6d1cad0721b52be2ff00f758fb9f" />
...
<Gist url="https://gist.github.com/usmansaleem/e723f25b827e0a925eaef2957a80132d" />
...
<Gist url="https://gist.github.com/usmansaleem/2a176a7b752fcb72f7f31964809696fe" />
...
This post is adapted and reproduced from [author's blog post](https://usmans.info/view/blog/tcp_client_using_vertx_kotlin_gradle)
