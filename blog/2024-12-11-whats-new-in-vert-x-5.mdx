...
The Vert.x gRPC Server supports the [gRPC Transcoding](https://vertx.io/docs/5.0.0.CR6/vertx-grpc/java/#_generate_transcoding_definitions)
protocol by default (i.e. without an intermediate proxy).

Here is a simple [example](https://github.com/vert-x3/vertx-examples/tree/5.x/grpc-examples#transcoding).
