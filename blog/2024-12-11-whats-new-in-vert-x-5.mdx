...
Vert.x gRPC handles timeout and deadlines in both [client](https://vertx.io/docs/5.0.0.CR4/vertx-grpc/java/#_timeout_and_deadlines_2)
and [server](https://vertx.io/docs/5.0.0.CR4/vertx-grpc/java/#_timeout_and_deadlines)
...
[Vert.x Service Resolver](https://vertx.io/docs/5.0.0.CR4/vertx-service-resolver/java/) is a new addition to
...
The interception [side](https://vertx.io/docs/5.0.0.CR4/vertx-http-proxy/java/#_proxy_interception) of our HTTP proxy
...
[available](https://vertx.io/docs/5.0.0.CR4/vertx-core/java/#_listening_to_unix_domain_sockets) for JDK 16 or greater.

### Connect options

TCP and HTTP clients have finer grained [Connect](https://vertx.io/docs/5.0.0.CR4/apidocs/io/vertx/core/net/ConnectOptions.html)
...
Application [launcher](https://vertx.io/docs/5.0.0.CR4/vertx-launcher-application/java/) is a new tool which addresses the
