...
authors:
  - name: Julien Viet
    github_id: vietj
summary: >-
  Eclipse Vert.x version 3.9.3 has just been released. It fixes quite a few bugs
  that have been reported by the community.
---

We are extremely pleased to announce that Eclipse Vert.x version 3.9.3 has been released.

Since the release of Vert.x 3.9.2, quite a few bugs have been reported. We would like to thank you all for reporting these issues.
