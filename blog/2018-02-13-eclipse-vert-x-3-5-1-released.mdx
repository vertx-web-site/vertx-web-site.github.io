...
authors:
  - name: Julien Viet
    github_id: vietj
summary: We have just released Vert.x 3.5.1!
---
...
You can checkout the [source on GitHub](https://github.com/vert-x3/vertx-junit5), read <Link href="/docs/[[...slug]]" as="/docs/vertx-junit5/java/"><a>the manual</a></Link> and learn from [the examples](https://github.com/vert-x3/vertx-examples/tree/master/junit5-examples).
