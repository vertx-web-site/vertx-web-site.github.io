...
export const meta = {
  ...
  summary: "In this second installment of our Vert.x Cassandra Client tutorial, we will add an endpoint that produces an array of RSS channels for a given user ID."
}

In <Link href="/blog/[[...slug]]" as="/blog/the-rss-reader-tutorial/" passHref={true}><a>the previous step</a></Link>, we have successfully implemented the first endpoint 
