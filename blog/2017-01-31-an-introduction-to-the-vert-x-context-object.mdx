...
export const meta = {
  ...
  summary: "Under the hood, the vert.x Context class plays a critical part in maintaining the thread-safety guarantees of verticles. Most of the time, vert.x coders don't need to make use of Context objects directly."
}
...
<img src={require("../assets/blog/vertx3-intro-to-context-object/VertxContextRelationships.png")} alt="Vertx Context/Thread/Verticle Relationships" />
