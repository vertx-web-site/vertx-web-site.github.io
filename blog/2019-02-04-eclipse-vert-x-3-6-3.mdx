...
authors:
  - name: Julien Viet
    github_id: vietj
summary: 'We have just released Vert.x 3.6.3, a bug fix release of Vert.x 3.6.x.'
---
...
In addition, the Kotlin support for data objects provides now a more [idiomatic](https://github.com/vert-x3/vertx-lang-kotlin/issues/103),
data object support.
