...
export const meta = {
  ...
  summary: `I figured it would be a good idea to give you a couple of examples how teaming
...
<img src={require("../assets/blog/ecmascript-6-7-on-the-jvm-with-typscript-and-vertx/output.png")} alt="Output of the verticle written in TypeScript" />
...
We've recently <Link href="/blog/[[...slug]]" as="/blog/vert-x-es6-back-to-the-future/" passHref={true}><a>published a post</a></Link>
