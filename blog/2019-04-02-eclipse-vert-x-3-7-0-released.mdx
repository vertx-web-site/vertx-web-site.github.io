...
export const meta = {
  ...
  summary: "We are extremely pleased to announce that the Eclipse Vert.x version 3.7.0 has been released."
}
...
For detailed usage instructions, please refer to the <Link href="/docs/[[...slug]]" as="/docs/vertx-web-graphql/java/" passHref={true}><a>Vert.x Web GraphQL documentation</a></Link>.
