---
title: Vert.x client for Apache Pinot
category: News
authors:
...
summary: >-
    ...
    it easier for vert.x users to use Apache Pinot in their applications, we introduce
    a vertx-pinot-client extension.
---

<Alert warning>

The blog post is informational and a teaser of upcoming changes to *vertx-pinot-client* which is under active
...
This project proposes to create a vertx-pinot-client extension. This extension will be a lightweight wrapper around
the existing Pinot Java client. It will also offer alternative transport for the client using vertx-web-client.
