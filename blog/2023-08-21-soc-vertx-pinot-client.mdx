...
To avoid blocking calls together, we discussed replacing `Future` with `CompletabeFutre`. The same change has already been [merged](https://github.com/apache/pinot/pull/10326)
now and will be available in the next release.
