export const meta = {
  ...
  authors: [{
    ...
    github_id: "thomasdarimont"
  }],
  summary: "In this blog post, you'll learn how to implement Single Sign-on with OpenID Connect and how to use Keycloak together with Eclipse Vert.x."
}
...
<img src={require("../assets/blog/vertx-keycloak-integration/2020-03-07-vertx-keycloak-integration.gif")} alt="Vert.x Keycloak Integration Demo" />
