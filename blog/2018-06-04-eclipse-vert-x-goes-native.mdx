...
export const meta = {
  ...
  summary: "This blog post introduces native image generation of Vert.x applications with GraalVM. Generated executables can be run without a JVM."
}
...
<Alert info title="Work in progress">
