...
export const meta = {
  ...
  summary: "We have just released Vert.x 3.7.1, a bug fix release of Vert.x 3.7.x and a few small features."
}
...
As you may know, the <Link href="/docs/[[...slug]]" as="/docs/vertx-rx/java2/#_rxified_api" passHref={true}><a>Vert.x _Rxified_ API</a></Link> is generated from the bare Vert.x API.
