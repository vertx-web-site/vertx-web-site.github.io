...
This post is part of the _Introduction to Vert.x_ series. So, let's have a quick look about the content of the previous posts. In [the first post](/blog/my-first-vert-x-3-application), we developed a very simple Vert.x 3 application, and saw how this application can be tested, packaged and executed. In [the last post](/blog/vert-x-application-configuration), we saw how this application became configurable and how we can use a random port in test.
