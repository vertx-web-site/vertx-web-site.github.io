...
authors:
  - name: Pavel Drankov
    github_id: Sammers21
summary: >-
  In this article, we will see how to set up the new Vert.x MQTT client. An
  example project is available on GitHub.
---

In this article, we will see how to set up the new Vert.x MQTT client. Actually, I have a [real example](https://github.com/Sammers21/vertx-mqtt-client-example) so you can try it quickly.
...
<img src="https://i.imgur.com/b4yYQJE.gif" width="1106" height="322" alt="Screencast" />
