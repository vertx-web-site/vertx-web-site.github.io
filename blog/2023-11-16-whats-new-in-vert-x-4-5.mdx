...
With [dynamic connection configuration](https://vertx.io/docs/vertx-pg-client/java/#_dynamic_connection_configuration) you can implement this trivially in Vert.x:
