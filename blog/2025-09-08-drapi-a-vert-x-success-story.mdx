...
<img src="https://opensource.hcltechsw.com/Domino-rest-api/assets/images/KEEPclasses.png" width="844" height="601" alt="How HCL Domino REST API works" />
...
Our clients have very diverse ideas about how to deal with TLS, termination and certificates. Vert.x flexible [TLS support](https://vertx.io/docs/vertx-core/java/#ssl) allows us to cater to these ideas.
