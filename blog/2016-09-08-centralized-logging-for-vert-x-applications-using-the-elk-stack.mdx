...
summary: >-
  This post entry describes a solution to achieve centralized logging of Vert.x
  applications using the ELK stack (Logstash, Elasticsearch, and Kibana).
---
...
![Overview of centralized logging with ELK](/images/blog/centralized-logging-using-elk/elk-overview.svg)
...
![Kibana Dashboard" width="550](/images/blog/centralized-logging-using-elk/kibana-dashboard.png)
...
<YouTubeEmbed id="8P-MgXSujes" title="Centralized logging for Vert.x applications using the ELK stack" />
