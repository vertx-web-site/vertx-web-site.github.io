export const meta = {
  ...
  summary: "This post entry describes a solution to achieve centralized logging of Vert.x applications using the ELK stack (Logstash, Elasticsearch, and Kibana)."
}
...
<img src={require("../assets/blog/centralized-logging-using-elk/kibana-dashboard.png")} alt="Kibana Dashboard" width="550" />
...
<iframe src="https://www.youtube.com/embed/8P-MgXSujes" frameBorder="0" allowFullScreen></iframe>
</div>
