export const meta = {
  ...
  summary: "Let's say, you heard someone saying that Vert.x is awesome. Ok great, but you may want to try it by yourself. Well, the next natural question is “where do I start ?”"
}
...
To create a _fat jar_, edit the `pom.xml` file and add the following code just before `</plugins>`:
