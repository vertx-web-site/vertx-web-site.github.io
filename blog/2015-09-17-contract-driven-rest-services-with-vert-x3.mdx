...
authors:
  - name: Paulo Lopes
    github_id: pmlopes
summary: >-
  We see a new trend in development where we are shifting from developing
  applications to APIs. More and more we see services being offered as REST APIs
  that we are allowed to consume.
---
...
![apiconsole](/images/blog/vertx3-contract-driven-rest-services/raml-console.png)
