...
export const meta = {
  ...
  summary: "We see a new trend in development where we are shifting from developing applications to APIs. More and more we see services being offered as REST APIs that we are allowed to consume."
}
...
If you do not like to write yaml in your editor you can always use the [API Designer](http://raml.org/projects.html) which gives you instant feedback on your API document and provides a testing platform.
...
<img src={require("../assets/blog/vertx3-contract-driven-rest-services/raml-console.png")} alt="apiconsole" />
