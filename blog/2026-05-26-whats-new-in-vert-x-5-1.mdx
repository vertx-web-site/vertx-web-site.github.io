...
The rise of quantum computers will make key exchange protocols such as x25519 obsolete as they will be able to
"crack" secret keys quickly. Vert.x proposes a quantum-safe key exchange protocol,
_x25519MLKEM768_ (official recommendation of NIST) to ensure sessions over TLS are safe against quantum computers.

## Misc features

- [Redis 8 / Valkey support](https://vertx.io/docs/vertx-redis-client/java/#_valkey)
