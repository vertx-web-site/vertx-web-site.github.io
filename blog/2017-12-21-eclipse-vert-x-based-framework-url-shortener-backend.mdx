...
export const meta = {
  ...
  summary: "We combine Vert.x with the serverless framework to write a microservice that runs on AWS Lambda."
}
...
<Gist url="https://gist.github.com/pendula95/583eb45bd0a7990136fba029bdcd555b" />
...
<Gist url="https://gist.github.com/pendula95/aeb4479162e6e33504add2af9fa68bc5" />
...
<Gist url="https://gist.github.com/pendula95/33adc47265072ed930c7df98c9ace7be" />
...
This is a re-publication of the following [blog post](http://lazarbulic.com/blog/2017/11/10/aws-lambda-vertx-framework-url-shortener-backend/)
