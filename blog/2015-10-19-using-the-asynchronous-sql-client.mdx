...
4. The [previous post](/blog/unit-and-integration-tests/) has presented how you can run integration tests to ensure the behavior of your application.
...
In the [next post](/blog/combine-vert-x-and-mongo-to-build-a-giant/), we see how the same application can use MongoDB instead of HSQL.
