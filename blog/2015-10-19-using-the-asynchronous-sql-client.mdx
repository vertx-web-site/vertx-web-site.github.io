...
export const meta = {
  ...
  summary: "Finally, back... This post is the fifth post of the introduction to vert.x blog series, after a not-that-small break. In this post we are going to see how we can use JDBC in a vert.x application."
}
...
4. The <Link href="/blog/[[...slug]]" as="/blog/unit-and-integration-tests/" passHref={true}><a>previous post</a></Link> has presented how you can run integration tests to ensure the behavior of your application.
...
<Alert info title="Closing connection">
...
In the <Link href="/blog/[[...slug]]" as="/blog/combine-vert-x-and-mongo-to-build-a-giant/" passHref={true}><a>next post</a></Link>, we see how the same application can use MongoDB instead of HSQL.
