export const meta = {
  ...
  summary: "The Vert.x team is pleased to announce the release of Vert.x 2.1.6"
}
...
The artifacts have been deployed to [Maven Central](http://search.maven.org/#search%7Cga%7C1%7Cg%3A%22io.vertx%22%20AND%20v%3A%222.1.6%22), and you can get the distribution on [Bintray](https://bintray.com/vertx/downloads/distribution/2.1.6/view).
