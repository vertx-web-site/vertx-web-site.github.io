...
authors:
  - name: Julien Viet
    github_id: vietj
summary: >-
  This is the second candidate release of Vert.x 5.
---

We are extremely pleased to announce the second candidate release of Eclipse Vert.x 5.
...
Vert.x gRPC handles timeout and deadlines in both [client](https://vertx.io/docs/5.0.0-CR2/vertx-grpc/java/#_timeout_and_deadlines_2)
and [server](https://vertx.io/docs/5.0.0-CR2/vertx-grpc/java/#_timeout_and_deadlines)
...
[Vert.x Service Resolver](https://vertx.io/docs/5.0.0-CR2/vertx-service-resolver/java/) is a new addition to
...
The interception [side](https://vertx.io/docs/5.0.0-CR2/vertx-http-proxy/java/#_proxy_interception) of our HTTP proxy
...
[available](https://vertx.io/docs/5.0.0-CR2/vertx-core/java/#_listening_to_unix_domain_sockets) for JDK 16 or greater.

### Connect options

TCP and HTTP clients have finer grained [Connect](https://vertx.io/docs/5.0.0-CR2/apidocs/io/vertx/core/net/ConnectOptions.html)
...
Application [launcher](https://vertx.io/docs/5.0.0-CR2/vertx-launcher-application/java/) is a new tool which addresses the
...
The release artifacts have been deployed to [Maven Central](https://search.maven.org/search?q=g:io.vertx%20AND%20v:5.0.0.CR2) and you can get the distribution on [Maven Central](https://repo1.maven.org/maven2/io/vertx/vertx-stack-manager/4.0.0-milestone1/).

Most importantly the documentation has been deployed on this preview web-site https://vertx.io/docs/5.0.0-CR2/
