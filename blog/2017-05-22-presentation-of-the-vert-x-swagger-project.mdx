...
export const meta = {
  ...
  summary: "This post is an introduction to the Vert.x-Swagger project, and describe how to use the Swagger-Codegen plugin and the SwaggerRouter class."
}
...
<img src={require("../assets/blog/vertx-swagger-presentation/GeneratedProject.png")} alt="Generated sources" />
