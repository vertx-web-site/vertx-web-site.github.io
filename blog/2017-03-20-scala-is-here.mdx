...
export const meta = {
  ...
  summary: "The rise of Scala as one of the most important languages on the JVM caught many (me included) by surprise. This hybrid of functional and imperative paradigms struck a chord with many developers."
}
...
<Alert info title="Future and Promise both need a ExecutionContext">
