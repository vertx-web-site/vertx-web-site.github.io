...
const SearchDialog = ({ open, onClose }: SearchDialogProps) => {
  return (
    <ModalOverlay
      ...
      className="fixed inset-0 z-[90] flex items-start justify-center bg-black/20 backdrop-blur-sm data-[entering]:animate-fade-in data-[exiting]:animate-fade-out dark:bg-black/50"
    >
