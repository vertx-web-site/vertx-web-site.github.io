...
const QuickSearch = ({ onClick }: QuickSearchProps) => {
  ...
  return (
    <>
      ...
      <button
        className="hidden h-8 w-48 cursor-pointer select-none items-center justify-between rounded border border-gray-300 bg-bg pl-3 pr-2 text-sm text-gray-600 transition-colors hover:border-gray-500 xl:flex 2xl:w-56"
