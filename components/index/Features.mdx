...
<FeaturesList>
<FeaturesItem icon={<Cpu />} title="Resource-efficient" className="col-span-2">
...
<FeaturesItem icon={<SlidersHorizontal />} title="Concurrent and asynchronous" className="col-span-2">
...
<FeaturesItem icon={<Feather />} title="Flexible" className="col-span-2">
...
<FeaturesItem icon={<Confetti />} title="Vert.x is fun" className="col-span-3">
...
<FeaturesItem icon={<Umbrella />} title="Ecosystem" className="col-span-3">
