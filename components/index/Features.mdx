...
import { Cpu, Confetti, Feather, SlidersHorizontal, Umbrella } from "@phosphor-icons/react";
...
<FeaturesList>
<FeaturesItem icon={<Cpu />} title="Resource-efficient" className="col-span-6 md:col-span-3 xl:col-span-2">
...
<FeaturesItem icon={<SlidersHorizontal />} title="Concurrent and asynchronous" className="col-span-6 md:col-span-3 xl:col-span-2">

People told you asynchronous programming is too hard for you?
We strive to make programming with Vert.x an approachable experience, without sacrificing correctness and performance.
...
<FeaturesItem icon={<Feather />} title="Flexible" className="col-span-6 md:col-span-3 xl:col-span-2">
...
<FeaturesItem icon={<Confetti />} title="Vert.x is fun" className="col-span-6 md:col-span-3 xl:col-span-3">
...
<FeaturesItem icon={<Umbrella />} title="Ecosystem" className="col-span-6 xl:col-span-3">
