...
----
compile 'io.vertx:vertx-service-proxy:4.1.8'
----
...
[source,groovy,subs="+attributes"]
----
compileOnly 'io.vertx:vertx-codegen:4.1.8'
----
* Gradle >= 5（在您的 `build.gradle` 文件中）：
...
annotationProcessor 'io.vertx:vertx-service-proxy:4.1.8'
----
...
[source]
----
compile "io.vertx:vertx-codegen:4.1.8:processor"
compile "io.vertx:vertx-service-proxy:4.1.8"
----
