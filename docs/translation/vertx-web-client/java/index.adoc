...
----
dependencies {
 compile 'io.vertx:vertx-web-client:4.2.0'
}
----
...
Vert.x web offers an HTTP response caching facility; to use it, you create a `link:../../apidocs/io/vertx/ext/web/client/CachingWebClient.html[CachingWebClient]`.
...
This can be configured by passing `link:../../apidocs/io/vertx/ext/web/client/CachingWebClientOptions.html[CachingWebClientOptions]` during client creation.
...
a `link:../../apidocs/io/vertx/ext/web/client/WebClientSession.html[WebClientSession]`. See <<_handling_private_responses>>.
...
To do so, implement `link:../../apidocs/io/vertx/ext/web/client/spi/CacheStore.html[CacheStore]`, and then you can provide it when creating your client.
...
To enable private response caching, the `link:../../apidocs/io/vertx/ext/web/client/CachingWebClient.html[CachingWebClient]` can be combined with the
`link:../../apidocs/io/vertx/ext/web/client/WebClientSession.html[WebClientSession]`. When this is done, public responses, those with the `public` directive
in the `Cache-Control` header, will be cached in the `link:../../apidocs/io/vertx/ext/web/client/spi/CacheStore.html[CacheStore]` the client was
...
To create a client that can cache private responses, pass a `link:../../apidocs/io/vertx/ext/web/client/CachingWebClient.html[CachingWebClient]` to
a `link:../../apidocs/io/vertx/ext/web/client/WebClientSession.html[WebClientSession]`.
...
`link:../../apidocs/io/vertx/ext/web/client/OAuth2WebClient.html[OAuth2WebClient]` for every user (session) and use it instead of the
`link:../../apidocs/io/vertx/ext/web/client/WebClient.html[WebClient]`.

=== Creating an Oauth2 Client

You create a `link:../../apidocs/io/vertx/ext/web/client/OAuth2WebClient.html[OAuth2WebClient]` instance as follows
...
Once created, a `link:../../apidocs/io/vertx/ext/web/client/OAuth2WebClient.html[OAuth2WebClient]` can be used instead of a
