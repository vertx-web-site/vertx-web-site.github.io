...
要想创建一个RX化的Mongo客户端，需要您确保导入了 `link:../../apidocs/io/vertx/rxjava3/ext/mongo/MongoClient.html[MongoClient]` 类。
...
`link:../../apidocs/io/vertx/rxjava3/core/streams/ReadStream.html[ReadStream]` 可以被转换成 `link:../../apidocs/io/reactivex/rxjava3/core/Flowable.html[Flowable]` 。这个功能会方便您处理大型数据集。
