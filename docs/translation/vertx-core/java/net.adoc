...
You write to a socket using one of `link:../../apidocs/io/vertx/core/streams/WriteStream.html#write-java.lang.Object-[write]`.
...
`link:../../apidocs/io/vertx/core/streams/WriteStream.html[WriteStream]` instances, so they can be used to pipe data to or from other
...
You can reduce the data format verbosity to only print the buffer length instead of the entire data
...
- JDK SSL engine when `link:../../apidocs/io/vertx/core/net/JdkSSLEngineOptions.html[JdkSSLEngineOptions]` is used
- OpenSSL engine when `link:../../apidocs/io/vertx/core/net/OpenSSLEngineOptions.html[OpenSSLEngineOptions]` is used
...
You can use `link:../../apidocs/io/vertx/core/net/NetClientOptions.html#setNonProxyHosts-java.util.List-[setNonProxyHosts]` to configure a list of host bypassing
...
HA PROXY protocol can be enabled by setting the option `link:../../apidocs/io/vertx/core/net/NetServerOptions.html#setUseProxyProtocol-boolean-[setUseProxyProtocol]`
