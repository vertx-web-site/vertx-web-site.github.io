...
You can do this by defining a `link:../../apidocs/io/vertx/core/eventbus/MessageCodec.html[codec]` for the objects you want to send.
...
`link:../../apidocs/io/vertx/core/eventbus/Message.html#reply-java.lang.Object-[reply]`.
...
You should also make sure you have a `link:../../apidocs/io/vertx/core/spi/cluster/ClusterManager.html[ClusterManager]` implementation on your classpath, for example the Hazelcast cluster manager.
