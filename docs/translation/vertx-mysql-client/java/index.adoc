...
有关 native transport 的详细信息，请参阅 [Vert.x 文档](https://vertx.io/docs/vertx-core/java/#_native_transports)。
...
有时您希望使用 MySQL 实用程序命令，我们为此提供支持。有关更多信息，请参阅 https://dev.mysql.com/doc/dev/mysql-server/8.0.12/page_protocol_command_phase_utility.html[MySQL 实用程序命令].
