...
access. You need to add the `io.vertx:vertx-auth-jwt:4.2.0` dependency to use `JWTAuthProvider`
...
`io.vertx:vertx-web-templ-mvel:4.2.0`. Create an instance of the MVEL template engine using:
...
`io.vertx:vertx-web-templ-jade:4.2.0`. Create an instance of the Jade template engine using:
...
`io.vertx:vertx-web-templ-handlebars:4.2.0`. Create an instance of the Handlebars template engine
...
`io.vertx:vertx-web-templ-thymeleaf:4.2.0`. Create an instance of the Thymeleaf template engine
...
`io.vertx:vertx-web-templ-freemarker:4.2.0`. Create an instance of the Apache FreeMarker template engine
...
`io.vertx:vertx-web-templ-pebble:4.2.0`. Create an instance of the Pebble template engine
...
To use Rocker, then add `io.vertx:vertx-web-templ-rocker:4.2.0` as a dependency to your project.
...
`io.vertx:vertx-web-templ-httl:4.2.0`. Create an instance of the HTTL template engine
...
`io.vertx:vertx-web-templ-rythm:4.2.0`. Create an instance of the Rythm template engine
