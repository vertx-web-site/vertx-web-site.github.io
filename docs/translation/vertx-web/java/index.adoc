...
access. You need to add the `io.vertx:vertx-auth-jwt:4.3.0` dependency to use `JWTAuthProvider`
...
`io.vertx:vertx-web-templ-mvel:4.3.0`. Create an instance of the MVEL template engine using:
...
`io.vertx:vertx-web-templ-jade:4.3.0`. Create an instance of the Jade template engine using:
...
`io.vertx:vertx-web-templ-handlebars:4.3.0`. Create an instance of the Handlebars template engine
...
`io.vertx:vertx-web-templ-thymeleaf:4.3.0`. Create an instance of the Thymeleaf template engine
...
`io.vertx:vertx-web-templ-freemarker:4.3.0`. Create an instance of the Apache FreeMarker template engine
...
`io.vertx:vertx-web-templ-pebble:4.3.0`. Create an instance of the Pebble template engine
...
To use Rocker, then add `io.vertx:vertx-web-templ-rocker:4.3.0` as a dependency to your project.
...
`io.vertx:vertx-web-templ-httl:4.3.0`. Create an instance of the HTTL template engine
...
`io.vertx:vertx-web-templ-rythm:4.3.0`. Create an instance of the Rythm template engine
...
`link:../../apidocs/io/vertx/core/streams/WriteStream.html[WriteStream]` so you can pump it to and from other read and write streams. The
`link:../../apidocs/io/vertx/ext/web/RoutingContext.html[RoutingContext]` is accessible for manual session management while the SockJS connection
is loaded using `link:../../apidocs/io/vertx/ext/web/handler/sockjs/SockJSSocket.html#routingContext--[routingContext]`. With this you can manage
the users and sessions accessible through `link:../../apidocs/io/vertx/ext/web/handler/sockjs/SockJSSocket.html#webSession--[webSession]`
and `link:../../apidocs/io/vertx/ext/web/handler/sockjs/SockJSSocket.html#webUser--[webUser]`.
