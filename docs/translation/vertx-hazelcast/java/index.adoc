...
If you are using Vert.x from the command line, the jar corresponding to this cluster manager (it will be named `vertx-hazelcast-4.2.5.jar`
...
the artifact: `io.vertx:vertx-hazelcast:4.2.5` in your project.
...
----
dependencies {
compile ("io.vertx:vertx-hazelcast:4.2.5"){
