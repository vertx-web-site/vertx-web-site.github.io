...
If you are using Vert.x from the command line, the jar corresponding to this cluster manager (it will be named `vertx-infinispan-4.2.7.jar`
...
the artifact: `io.vertx:vertx-infinispan:4.2.7` in your project.
