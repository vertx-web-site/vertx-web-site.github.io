...
----
compile 'io.vertx:vertx-auth-otp:4.2.0'
----
...
To create an instance of the Hotp auth provider, use `link:../../apidocs/io/vertx/ext/auth/otp/totp/TotpAuth.html#create-io.vertx.ext.auth.otp.totp.TotpAuthOptions-[TotpAuth.create]` as follows
