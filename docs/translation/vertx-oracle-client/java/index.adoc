...
----
dependencies {
 compile 'io.vertx:vertx-oracle-client:4.2.2'
}
----
...
Apart from configuring with a `link:../../apidocs/io/vertx/oracleclient/OracleConnectOptions.html[OracleConnectOptions]` data object, ww also provide you with an alternative way to connect when you want to configure with a connection URI:
