...
If you use RxJava 2, you can inject a `io.vertx.reactivex.core.Vertx` (rather than `io.vertx.core.Vertx`) just adding the dependency `io.vertx:vertx-junit5-rx-java2`.
