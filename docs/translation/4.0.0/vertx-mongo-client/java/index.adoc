...
----
compile 'io.vertx:vertx-mongo-client:4.0.0'
----
...
In that case you can use `link:../../apidocs/io/vertx/ext/mongo/MongoClient.html#create-io.vertx.core.Vertx-io.vertx.core.json.JsonObject-[MongoClient.create]`.
...
A file can be stored with additional options with `link:../../apidocs/io/vertx/ext/mongo/MongoGridFsClient.html#uploadFileWithOptions-java.lang.String-io.vertx.ext.mongo.GridFsUploadOptions-io.vertx.core.Handler-[uploadFileWithOptions]`
passing in an instance of `link:../../apidocs/io/vertx/ext/mongo/GridFsUploadOptions.html[GridFsUploadOptions]`. When it
...
Streams can be uploaded to GridFS using `link:../../apidocs/io/vertx/ext/mongo/MongoGridFsClient.html#uploadByFileName-io.vertx.core.streams.ReadStream-java.lang.String-io.vertx.core.Handler-[uploadByFileName]`.
...
Streams can be uploaded to GridFS using `link:../../apidocs/io/vertx/ext/mongo/MongoGridFsClient.html#uploadByFileNameWithOptions-io.vertx.core.streams.ReadStream-java.lang.String-io.vertx.ext.mongo.GridFsUploadOptions-io.vertx.core.Handler-[uploadByFileNameWithOptions]`
passing in an instance of `link:../../apidocs/io/vertx/ext/mongo/GridFsUploadOptions.html[GridFsUploadOptions]`.
Once the stream is uploaded, the result handler will be called with the ID generated by GridFS.
...
`link:../../apidocs/io/vertx/ext/mongo/GridFsUploadOptions.html[GridFsUploadOptions]` has the following fields:
...
Streams can be downloaded from GridFS using a file name with `link:../../apidocs/io/vertx/ext/mongo/MongoGridFsClient.html#downloadByFileName-io.vertx.core.streams.WriteStream-java.lang.String-io.vertx.core.Handler-[downloadByFileName]`.
...
`stream` : the `link:../../apidocs/io/vertx/core/streams/WriteStream.html[WriteStream]` to download to
`fileName` : the name of the file that will be downloaded to the stream
`options` : an instance of `link:../../apidocs/io/vertx/ext/mongo/GridFsDownloadOptions.html[GridFsDownloadOptions]`
...
Streams can be downloaded using the ID generated by GridFS with `link:../../apidocs/io/vertx/ext/mongo/MongoGridFsClient.html#downloadById-io.vertx.core.streams.WriteStream-java.lang.String-io.vertx.core.Handler-[downloadById]`.
Once the stream is downloaded a result handler will be called with the length of the stream as a Long.
