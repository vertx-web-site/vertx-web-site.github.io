...
----
dependencies {
 compile 'io.vertx:vertx-db2-client:4.1.1'
}
----
...
`link:../../apidocs/io/vertx/db2client/DB2Connection.html[connection]` from a pool
...
The `link:../../apidocs/io/vertx/db2client/DB2Pool.html[DB2Pool]` allows you to create a pool or a pooled client
