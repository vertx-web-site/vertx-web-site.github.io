...
----
compile 'io.vertx:vertx-service-proxy:4.2.6'
----
...
[source,groovy,subs="+attributes"]
----
compileOnly 'io.vertx:vertx-codegen:4.2.6'
----
* Gradle >= 5 (in your `build.gradle` file):
...
annotationProcessor 'io.vertx:vertx-service-proxy:4.2.6'
----
...
[source]
----
compile "io.vertx:vertx-codegen:4.2.6:processor"
compile "io.vertx:vertx-service-proxy:4.2.6"
----
