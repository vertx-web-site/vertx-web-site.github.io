...
----
compile 'io.vertx:vertx-service-proxy:4.1.1'
----
...
[source,groovy,subs="+attributes"]
----
compileOnly 'io.vertx:vertx-codegen:4.1.1'
----
* Gradle >= 5（在您的 `build.gradle` 文件中）：

[source,groovy,subs="+attributes"]
----
annotationProcessor 'io.vertx:vertx-codegen:4.1.1:processor'
annotationProcessor 'io.vertx:vertx-service-proxy:4.1.1'
----
...
[source]
----
compile "io.vertx:vertx-codegen:4.1.1:processor"
compile "io.vertx:vertx-service-proxy:4.1.1"
----
