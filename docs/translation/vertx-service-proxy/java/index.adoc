...
----
compile 'io.vertx:vertx-service-proxy:4.1.4'
----
...
[source,groovy,subs="+attributes"]
----
compileOnly 'io.vertx:vertx-codegen:4.1.4'
----
* Gradle >= 5 (in your `build.gradle` file):

[source,groovy,subs="+attributes"]
----
annotationProcessor 'io.vertx:vertx-codegen:4.1.4:processor'
annotationProcessor 'io.vertx:vertx-service-proxy:4.1.4'
----
...
[source]
----
compile "io.vertx:vertx-codegen:4.1.4:processor"
compile "io.vertx:vertx-service-proxy:4.1.4"
----
