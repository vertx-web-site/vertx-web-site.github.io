...
You may start by reading the https://www.graphql-java.com/documentation/v17/[GraphQL-Java documentation].
...
----
compile 'io.vertx:vertx-web-graphql:4.2.3'
----
...
To https://vertx.io/docs/vertx-core/java/#golden_rule[avoid blocking the event loop], all you have to do is implement https://www.graphql-java.com/documentation/v17/data-fetching/[data fetchers] that return a `CompletionStage` instead of the result directly.
