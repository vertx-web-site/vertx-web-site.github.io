...
为https://vertx.io/docs/vertx-core/java/#golden_rule[避免阻塞 eventloop] ，您需要做的只是实现一个 https://www.graphql-java.com/documentation/v16/data-fetching/[data fetchers] 并返回 `CompletionStage` 而不是直接返回结果。
