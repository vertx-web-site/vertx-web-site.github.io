...
<Question question={<React.Fragment>已启用 <code>logActivity</code> 配置，但仍未有日志输出</React.Fragment>}>
...
Vert.x拥有此类解决方案的客户端：Vert.x AMQP客户端，适用于Vert.x的RabbitMQ客户端或Vert.x-Stomp。
