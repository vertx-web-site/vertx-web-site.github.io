...
<div className="get-started-screenshot">
  <a href="https://start.vertx.io">
    <img src={require("../assets/get-started/starter-screenshot.png")} className="img-fluid" />
  </a>
</div>
...
[Maven](http://start.vertx.io/starter.zip?vertxDependencies=vertx-web) or using
[Gradle](http://start.vertx.io/starter.zip?vertxDependencies=vertx-web&buildTool=gradle)
...
Now that the server is up and running, try to send a request using `http` tool (or another tool of your choice):
...
<ul className="get-started-next-steps">
  ...
  <Link href="/"><a><li>
    <h4>Ecosystem</h4>
    Check out the ecosystem of tools, libraries, and frameworks around Vert.x
  </li></a></Link>
