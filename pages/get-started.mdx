...
您也可以从以下地址直接下载示例项目：
<a href={`https://start.vertx.io/starter.zip?vertxDependencies=vertx-web&vertxVersion=${latestRelease.version}&jdkVersion=11`}>Maven</a> 或 <a href={`https://start.vertx.io/starter.zip?vertxDependencies=vertx-web&buildTool=gradle&vertxVersion=${docsVersions[0]}&jdkVersion=11`}>Gradle</a>。
