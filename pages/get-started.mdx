...
[Maven](http://start.vertx.io/starter.zip?vertxDependencies=vertx-web&vertxVersion=4.0.0.CR1&jdkVersion=11) or using
[Gradle](http://start.vertx.io/starter.zip?vertxDependencies=vertx-web&buildTool=gradle&vertxVersion=4.0.0.CR1&jdkVersion=11)
