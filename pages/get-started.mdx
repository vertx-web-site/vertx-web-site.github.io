...
[_Maven_](http://start.vertx.io/starter.zip?vertxDependencies=vertx-web) or using
[_Gradle_](http://start.vertx.io/starter.zip?vertxDependencies=vertx-web&buildTool=gradle)
