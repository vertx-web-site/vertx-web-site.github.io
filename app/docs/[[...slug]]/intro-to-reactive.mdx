...
<img src={require("@/assets/introduction/microservices.svg")} alt="Microservices" className="mx-auto" />
...
<img src={require("@/assets/introduction/threads.svg")} alt="Threads" className="mx-auto" />
...
<img src={require("@/assets/introduction/blocking-io.svg")} alt="Blocking I/O" className="mx-auto" />
...
<img src={require("@/assets/introduction/event-loop.svg")} alt="Event loop" className="mx-auto" />
...
<img src={require("@/assets/introduction/async.svg")} alt="Asynchronous programming" className="mx-auto" />
...
<img src={require("@/assets/introduction/failures.svg")} alt="Failures" className="mx-auto" />
...
<img src={require("@/assets/introduction/ecosystem.svg")} alt="Ecosystem" className="mx-auto" />
