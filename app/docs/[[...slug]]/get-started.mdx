...
<Step n={1}>Bootstrap</Step>

To create a new project, go to [start.vertx.io](https://start.vertx.io).

<a href="https://start.vertx.io">
  <img src={require("@/assets/get-started/starter-screenshot.png")} className="border border-gray-200 rounded-sm p-4" />
</a>
...
<CodeExamples className="not-prose">
